...
db_username = Dotenvy.env!("DB_USERNAME", :string)
db_password = Dotenvy.env!("DB_PASSWORD", :string)
db_name = Dotenvy.env!("DB_NAME", :string)
db_host = Dotenvy.env!("DB_HOSTNAME", :string)
secret_key = Dotenvy.env!("SECRET_KEY_JWK", :string)

aws_access_key_id = Dotenvy.env!("AWS_ACCESS_KEY_ID", :string)
...
#
#     PHX_SERVER=true bin/triggerflow start
#
...
if config_env() == :prod do
  ...
  config :spl, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
